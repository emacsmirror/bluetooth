...
(defconst bluetooth--manufacturer-ids
  #s(hash-table size 2500 data
		(#x0000 "Ericsson Technology Licensing"
...
(defun bluetooth--manufacturer (id)
  "Determine manufacturer name from ID."
  (or (gethash id bluetooth--manufacturer-ids)
      "unknown"))
