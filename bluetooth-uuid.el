;;; bluetooth-uuid.el --- UUID parsing functions for bluetooth mode  -*- lexical-binding: t; -*-
...
(eval-and-compile
  (defconst bluetooth-uuid--base-uuid "0000-1000-8000-00805f9b34fb"
    "Bluetooth base UUID."))
...
;;   - a field specification (e.g. bluetooth-uuid--class-major-dev-classes)
...
(defconst bluetooth-uuid--class-major-services
  '((name . "major service classes")
    (mask . #xffe000)
    (shift . 0)
    (fn . bluetooth-uuid--class-parse-bitfield)
    (next . bluetooth-uuid--class-major-dev-classes)
...
(defconst bluetooth-uuid--class-major-dev-classes
  '((name . "major device class")
    (mask . #x1f00)
    (shift . -8)
    (fn . bluetooth-uuid--class-parse-major)
    (next . bluetooth-uuid--class-get-minor)
    (data . ((#x0 . ("Miscellaneous" . nil))
             (#x1 . ("Computer" . bluetooth-uuid--class-computer-minor-classes))
             (#x2 . ("Phone" . bluetooth-uuid--class-phone-minor-classes))
             (#x3 . ("LAN/Network Access point" .
                     bluetooth-uuid--class-network-minor-classes))
             (#x4 . ("Audio/Video" . bluetooth-uuid--class-av-minor-classes))
             (#x5 . ("Peripheral" . bluetooth-uuid--class-peripheral-minor-classes))
             (#x6 . ("Imaging" . bluetooth-uuid--class-imaging-minor-classes))
             (#x7 . ("Wearable" . bluetooth-uuid--class-wearable-minor-classes))
             (#x8 . ("Toy" . bluetooth-uuid--class-toy-minor-classes))
             (#x9 . ("Health" . bluetooth-uuid--class-health-minor-classes))
             (#xf . ("Unspecified" . nil)))))
  "Bluetooth major device classes.")

(defconst bluetooth-uuid--class-computer-minor-classes
  '((name . "minor device class")
    (mask . #xfc)
    (shift . -2)
    (fn . bluetooth-uuid--class-parse-value)
    (next . nil)
...
(defconst bluetooth-uuid--class-phone-minor-classes
  '((name . "minor device class")
    (mask . #xfc)
    (shift . -2)
    (fn . bluetooth-uuid--class-parse-value)
...
(defconst bluetooth-uuid--class-network-minor-classes
  '((name . "minor device class")
    (mask . #xe0)
    (shift . -5)
    (fn . bluetooth-uuid--class-parse-value)
...
(defconst bluetooth-uuid--class-av-minor-classes
  '((name . "minor device class")
    (mask . #xfc)
    (shift . -2)
    (fn . bluetooth-uuid--class-parse-value)
...
(defconst bluetooth-uuid--class-peripheral-minor-classes
  '((name . "minor device class")
    (mask . #xfc)
    (shift . -2)
    (fn . bluetooth-uuid--class-parse-peripheral)
    (next . nil)
...
(defconst bluetooth-uuid--class-imaging-minor-classes
  '((name . "minor device class")
    (mask . #xf0)
    (shift . 0)
    (fn . bluetooth-uuid--class-parse-bitfield)
...
(defconst bluetooth-uuid--class-wearable-minor-classes
  '((name . "minor device class")
    (mask . #xfc)
    (shift . -2)
    (fn . bluetooth-uuid--class-parse-value)
...
(defconst bluetooth-uuid--class-toy-minor-classes
  '((name . "minor device class")
    (mask . #xfc)
    (shift . -2)
    (fn . bluetooth-uuid--class-parse-value)
...
(defconst bluetooth-uuid--class-health-minor-classes
  '((name . "minor device class")
    (mask . #xfc)
    (shift . -2)
    (fn . bluetooth-uuid--class-parse-value)
...
(defconst bluetooth-uuid--uuids
  `((#xfff0 . ,bluetooth-uuid--sdo-uuids)
    (#xfc00 . ,bluetooth-uuid--member-uuids)
    (#x1800 . ,bluetooth-uuid--gatt-service-uuids)
    (#x0 . ,bluetooth-uuid--service-class-uuids))
                ...
                (let-alist field-def
                  (let* ((m-field (ash (logand class .mask) .shift))
                    ...
                    (cond ((functionp .next)
                          ...
                          (t (nreverse n-acc)))))))
    (parse bluetooth-uuid--class-major-services '())))

(defun bluetooth-uuid--class-parse-bitfield (bitfield data)
...
(defun bluetooth-uuid--class-parse-peripheral (field data)
  ...
  (-let (((cat-mask . categories) (cl-first data))
    ...
    (or (list (bluetooth-uuid--class-parse-value (logand cat-mask field)
                                                 categories)
              (bluetooth-uuid--class-parse-value (logand sub-mask field)
                                                 sub-groups))
        "unknown")))

(defun bluetooth-uuid--class-get-minor (field data)
...
;; Last updated: 01. Jan 2022
(defconst bluetooth-uuid--manufacturer-ids
  #s(hash-table
     size 3000 data
     (#x0000
...
(defun bluetooth-uuid-manufacturer-from-id (id)
  "Return manufacturer name for given ID."
  (gethash id bluetooth-uuid--manufacturer-ids))

(defun bluetooth-uuid-interpret (uuids)
  "Interpret device UUIDS.
